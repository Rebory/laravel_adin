...
<form id="selectForm2" class="parsley-style-1" method="post" action="{{ route('sliders.store') }}" enctype="multipart/form-data" >
@csrf
...
<div class="col-sm-9 mg-t-10 mg-sm-t-0">
<input type="text" class="form-control" name="txt5" >
</div>
</div>
 </div>
