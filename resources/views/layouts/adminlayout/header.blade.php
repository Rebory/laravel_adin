...
<html lang="en">
    <head>
        ...
        <title>Logged in as {{ Auth::user()->name }}</title>
        <!-- vendor css -->
        <link href="{{ asset('backend_lib/font-awesome/css/font-awesome.css') }}" rel="stylesheet">
        <link href="{{ asset('backend_lib/Ionicons/css/ionicons.css') }}" rel="stylesheet">
        <link href="{{ asset('backend_lib/perfect-scrollbar/css/perfect-scrollbar.min.css') }}" rel="stylesheet">
        <link href="{{ asset('backend_lib/select2/css/select2.min.css') }}" rel="stylesheet">
        <!-- Slim CSS -->
        ...
        <div class="slim-header with-sidebar">
            <div class="container-fluid">
                <div class="slim-header-left">
                    <h6 class="slim-logo"><a href="{{ url('/admin/dashboard') }}"> Admin</a></h6>
                ...
                <div class="slim-header-right">
                    <div class="dropdown dropdown-a" data-toggle="tooltip" title="Activity Logs">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <div class="dropdown-list-footer">
                                <a href="#"><i class="fa fa-angle-down"></i> Show All Activities</a>
                            </div>
                        </div>
                        <!-- dropdown-menu-right -->
                    </div>
                    ...
                    <div class="dropdown dropdown-b" data-toggle="tooltip" title="Notifications">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <div class="dropdown-list">
                                ...
                                <a href="" class="dropdown-link read">
                                    <div class="media">
                                        <img src="{{asset('images/backend_img/500x500.png')}}" alt="">
                                        <div class="media-body">
                    ...
                    <div class="dropdown dropdown-c">
                        <a href="#" class="logged-user" data-toggle="dropdown">
                            <img src="{{ asset(Auth::user()->upic) }}" alt="">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <nav class="nav">
                                ...
                                <a href="{{ url('/admin/settings')}}" class="nav-link"><i class="icon ion-ios-gear"></i> Account Settings</a>
